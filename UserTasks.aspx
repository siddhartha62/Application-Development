s<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserTasks.aspx.cs" Inherits="MilestoneThreeData.UserTasks" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">User Task Assignments</title>
...
<li><a href="UserTasks.aspx"class="active"><i class="bi bi-clipboard-check"></i> <span>Users Task</span></a></li>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                <h1 class="title"><i class="bi bi-clipboard-check"></i>User Task Assignments</h1>
                <div class="actions">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                DataKeyNames="USER_ID,TASK_ID" DataSourceID="SqlDataSource1" CssClass="grid-style" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Delete" CssClass="button delete-btn"
                                OnClientClick="return confirm('Are you sure you want to delete this task assignment?');">
                    ...
                    <asp:BoundField DataField="ROLE_IN_TASK" HeaderText="Role" SortExpression="ROLE_IN_TASK" />
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_ID,TASK_ID"
                DataSourceID="SqlDataSource1" CssClass="form-view-container">
                <EditItemTemplate>
                    <div class="form-edit">
                        <h3><i class="bi bi-pencil-square"></i> Edit Task Assignment</h3>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="ROLE_IN_TASKTextBox" runat="server" Text='<%# Bind("ROLE_IN_TASK") %>' CssClass="form-input" />
                        </div>
                        <div class="form-group">
                ...
                <InsertItemTemplate>
                    <div class="form-insert">
                        <h3><i class="bi bi-person-plus-fill"></i> New Task Assignment</h3>
                        <div class="form-group">
                            <label class="form-label">User ID:</label>
                    ...
                    <div class="form-view">
                        <div class="form-actions">
                            <asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New" CssClass="button">
                                <i class="bi bi-plus-lg"></i> Add New Task Assignment
                            </asp:LinkButton>
                        </div>
                    </div>
                </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                DeleteCommand="DELETE FROM &quot;USERTASKS&quot; WHERE &quot;USER_ID&quot; = :original_USER_ID AND &quot;TASK_ID&quot; = :original_TASK_ID AND ((&quot;ROLE_IN_TASK&quot; = :original_ROLE_IN_TASK) OR (&quot;ROLE_IN_TASK&quot; IS NULL AND :original_ROLE_IN_TASK IS NULL)) AND ((&quot;ASSIGNED_DATE&quot; = :original_ASSIGNED_DATE) OR (&quot;ASSIGNED_DATE&quot; IS NULL AND :original_ASSIGNED_DATE IS NULL))"
                InsertCommand="INSERT INTO &quot;USERTASKS&quot; (&quot;USER_ID&quot;, &quot;TASK_ID&quot;, &quot;ROLE_IN_TASK&quot;, &quot;ASSIGNED_DATE&quot;) VALUES (:USER_ID, :TASK_ID, :ROLE_IN_TASK, :ASSIGNED_DATE)"
                OldValuesParameterFormatString="original_{0}"
                ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
                SelectCommand="SELECT &quot;USER_ID&quot;, &quot;TASK_ID&quot;, &quot;ROLE_IN_TASK&quot;, &quot;ASSIGNED_DATE&quot; FROM &quot;USERTASKS&quot;"
                UpdateCommand="UPDATE &quot;USERTASKS&quot; SET &quot;ROLE_IN_TASK&quot; = :ROLE_IN_TASK, &quot;ASSIGNED_DATE&quot; = :ASSIGNED_DATE WHERE &quot;USER_ID&quot; = :original_USER_ID AND &quot;TASK_ID&quot; = :original_TASK_ID AND ((&quot;ROLE_IN_TASK&quot; = :original_ROLE_IN_TASK) OR (&quot;ROLE_IN_TASK&quot; IS NULL AND :original_ROLE_IN_TASK IS NULL)) AND ((&quot;ASSIGNED_DATE&quot; = :original_ASSIGNED_DATE) OR (&quot;ASSIGNED_DATE&quot; IS NULL AND :original_ASSIGNED_DATE IS NULL))">
                <DeleteParameters>
                    <asp:Parameter Name="original_USER_ID" Type="Decimal" />
                    <asp:Parameter Name="original_TASK_ID" Type="Decimal" />
                    <asp:Parameter Name="original_ROLE_IN_TASK" Type="String" />
                    <asp:Parameter Name="original_ASSIGNED_DATE" Type="DateTime" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="USER_ID" Type="Decimal" />
                    <asp:Parameter Name="TASK_ID" Type="Decimal" />
                    <asp:Parameter Name="ROLE_IN_TASK" Type="String" />
